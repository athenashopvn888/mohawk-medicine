...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at Mohawk Medicine" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="MEB01" />
      <input type="hidden" name="StoreName" value="Mohawk Medicine" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at Mohawk Medicine?</span>
      ...
      <div className={styles.formSection}>
        ...
        <fieldset className={styles.choiceGroup}>
          <legend>Can you reliably get to Eglinton Avenue East for scheduled shifts?</legend>
