...
export const metadata: Metadata = {
  title: { absolute: "Budtender Or Manager Application | Mohawk Medicine" },
  description:
    "Apply online for budtender or manager opportunities at Mohawk Medicine. Submit availability, customer-service experience, motivation, determination, and a required selfie.",
  alternates: {
    canonical: "https://mohawkmedicine.com/careers/budtender",
  },
};
...
const applicantFaqs = [
  ...
  },
  {
    ...
    a: "Tell us your real availability, earliest start date, retail background, what motivates you, and why you want to work with Mohawk Medicine.",
  },
  {
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            <span className={styles.eyebrow}>Mohawk Medicine Careers</span>
            <h1>Budtenders / Managers Wanted</h1>
            <p>
              Mohawk Medicine is collecting applications from sharp, friendly budtender and manager candidates who can help customers shop with confidence and keep the store running smooth.
            </p>
          ...
          <div className={styles.heroPanel} aria-label="Hiring role snapshot">
            ...
            <ul>
              ...
              <li>Late-shift availability is a plus at Mohawk Medicine</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className={styles.contentGrid}>
          ...
          <section id="application" className={styles.formPanel} aria-label="Budtender application form">
            <div className={styles.formIntro}>
              ...
              <p>
                This form sends your response to the shared Athena Store Applications sheet under MEB01.
              </p>
