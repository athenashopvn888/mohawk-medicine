    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.infoText}>
          ...
          <Link href="/visit">24-hour Scarborough walk-in guide</Link>. For local cannabis delivery from this Eglinton East pin, use the{" "}
          <Link href="/cannabis-delivery-scarborough">Scarborough cannabis delivery page</Link>. For dispensary near me / Scarborough pin questions, use the{" "}
