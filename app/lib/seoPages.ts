...
export const SEO_PAGES: SeoPageData[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Mohawk Medicine is more than just a flower shop. We carry a comprehensive selection of cannabis edibles (gummies, chocolates, baked goods), vape pens and disposable vapes, concentrates (shatter, wax, hash, diamonds, live resin), pre-rolled joints, magic mushrooms, native cigarettes, rolling papers, and accessories. Our live digital menu at mohawkmedicine.com updates in real time so you always know exactly what's in stock before you make the trip.",
      },
      {
    ...
    faqs: [
      ...
      { q: "What cannabis products does Mohawk Medicine carry?", a: "We carry 200+ strains of cannabis flower across 5 quality tiers (Exotic, Premium, AAA+, AA, Budget), plus edibles, vapes, concentrates, pre-rolls, magic mushrooms, native cigarettes, and accessories. Our menu updates in real time online." },
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "When you make the trip up to Mohawk, make it count. Mohawk Medicine carries a full selection including 200+ flower strains, edibles, vape pens, disposable vapes, concentrates (shatter, wax, hash, live resin), pre-rolled joints, magic mushrooms, native cigarettes, and accessories. Check our live online menu at mohawkmedicine.com before you visit to see exactly what's in stock.",
      },
    ],
    faqs: [
