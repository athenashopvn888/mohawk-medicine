...
export function getItemData(category: string, name: string): ItemEffects {
  ...
  if (cat === "EDIBLES") {
    return {
      ...
      description: `${name} is a premium cannabis edible available at Mohawk Medicine. Made with high-quality distillate or full-spectrum extract, it provides a consistent, long-lasting, and discreet experience. Perfect for those who prefer not to smoke while still enjoying the full benefits of cannabis.`,
      metaDescription: `Buy ${name} cannabis edibles in Toronto at Mohawk Medicine. Consistent, discreet, and long-lasting effects. Walk-in available 24/7.`,
  ...
  if (cat.includes("VAPE")) {
    return {
      ...
      description: `${name} is a high-quality vape product available at Mohawk Medicine. Designed for convenience and discretion, this vape delivers smooth, flavorful vapor and rapid effects. Engineered for reliability, it ensures a premium experience from the first pull to the last.`,
      metaDescription: `Shop ${name} vape pens and cartridges in Toronto at Mohawk Medicine. Fast-acting and potent. Walk-in available 24/7.`,
  ...
  if (cat === "CONCENTRATES") {
    return {
      ...
      description: `${name} is a premium cannabis concentrate known for its exceptional purity and potency. Crafted using advanced extraction techniques, it preserves the rich terpene profile of the original strain for maximum flavor and effect. Available now at Mohawk Medicine.`,
      metaDescription: `Buy ${name} cannabis concentrate in Toronto at Mohawk Medicine. Highly potent and pure extracts. Walk-in available 24/7.`,
  ...
  if (cat === "PREROLLS") {
    return {
      ...
      metaDescription: `Get ${name} pre-rolled joints in Toronto at Mohawk Medicine. Premium flower, perfectly rolled. Walk-in available 24/7.`,
  ...
  if (cat === "MAGIC & OTHERS") {
    return {
      ...
      metaDescription: `Shop ${name} magic mushrooms and psilocybin products in Toronto at Mohawk Medicine. High quality and consistent. Walk-in available 24/7.`,
