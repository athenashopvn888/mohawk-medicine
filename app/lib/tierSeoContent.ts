...
export const TIER_SEO: Record<string, TierSeoData> = {
  EXOTIC: {
    seoTitle: "Exotic Cannabis Flower Scarborough - Ultra-Rare, Top-Shelf Genetics",
    seoIntro: "Explore the Exotic tier at Eglinton Ave E Medicine - our most exclusive cannabis flower selection. Hand-picked strains with THC levels up to 39%, stunning bag appeal, and unique terpene profiles you won't find anywhere else in Toronto, Scarborough.",
    sections: [
      {
        heading: "What Makes Exotic Flower Special?",
        body: "Exotic cannabis flower represents the absolute pinnacle of cannabis cultivation. These strains are grown by elite craft cultivators, hand-trimmed to perfection, and selected for their exceptional terpene profiles, bag appeal, and potency. at Eglinton Ave E Medicine, our Exotic tier features strains with THC levels ranging from 35% to 39% - the highest potency flower available in Toronto, Scarborough.",
      },
      {
  ...
  PREMIUM: {
    seoTitle: "Premium Cannabis Flower Scarborough - Hand-Picked Connoisseur Grade",
  ...
  "AAA+": {
    seoTitle: "AAA+ Cannabis Flower Scarborough - Heavy Hitters at Great Prices",
  ...
  AA: {
    seoTitle: "AA Cannabis Flower Scarborough - Quality Daily Drivers",
  ...
  BUDGET: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Budget flower starts at just $3 per gram. Value ounces start from $40 - some of the best prices you'll find in Toronto, Scarborough. Our 3g bundle pricing applies here too, giving you even more savings.",
      },
    ],
    faqs: [
