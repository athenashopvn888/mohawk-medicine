...
export const TIER_SEO: Record<string, TierSeoData> = {
  EXOTIC: {
    seoTitle: "Exotic Cannabis Flower Scarborough â€” Ultra-Rare, Top-Shelf Genetics",
    seoIntro: "Explore the Exotic tier at Eglinton Ave E Medicine â€” our most exclusive cannabis flower selection. Hand-picked strains with THC levels up to 39%, stunning bag appeal, and unique terpene profiles you won't find anywhere else in Toronto, Scarborough.",
    sections: [
      {
        heading: "What Makes Exotic Flower Special?",
        body: "Exotic cannabis flower represents the absolute pinnacle of cannabis cultivation. These strains are grown by elite craft cultivators, hand-trimmed to perfection, and selected for their exceptional terpene profiles, bag appeal, and potency. at Eglinton Ave E Medicine, our Exotic tier features strains with THC levels ranging from 35% to 39% â€” the highest potency flower available in Toronto, Scarborough.",
      },
      {
        heading: "Exotic Pricing â€” $20/g with Buy 2g Get 1g FREE",
        body: "Our Exotic flower starts at $20 per gram. With our Buy 2g Get 1g FREE promotion, you get 3 grams for just $40 â€” that's $13.33/g. For even better value, our Buy 3g Get 3g FREE deal gives you 6 grams for $60 â€” just $10.00/g. 14g is available for $140 ($10/g) and full ounces (28g) for $250 ($8.93/g).",
      },
      {
        heading: "Why Shop Exotic at Eglinton Ave E Medicine?",
        body: "Mohawk Medicine is located at 2655 Eglinton Ave E in the heart of Scarborough's ByWard Market neighbourhood. Our live digital menu is updated in real time, so you can check exactly what Exotic strains are in stock before you visit. Our knowledgeable budtenders can help you find the perfect strain based on your preferred effects, aroma, and potency level.",
      },
    ],
    faqs: [
      ...
      { q: "Is Exotic worth the price?", a: "If you value the highest potency, rarest genetics, and best bag appeal, Exotic is absolutely worth it. Our promos bring the per-gram price down significantly â€” as low as $8.93/g for an ounce." },
    ],
  },

  PREMIUM: {
    seoTitle: "Premium Cannabis Flower Scarborough â€” Hand-Picked Connoisseur Grade",
    seoIntro: "Shop Premium cannabis flower at Eglinton Ave E Medicine, Scarborough. Connoisseur-grade strains with THC 32-34%, exceptional flavour, and smooth smoke. Starting at $15/g.",
    sections: [
      {
      ...
      {
        heading: "Premium Pricing â€” $15/g with FREE Gram Promos",
      ...
      },
      {
        ...
        body: "at Eglinton Ave E Medicine on Scarborough St, our Premium tier offers the best quality-to-price ratio in the neighbourhood. Every strain in this tier has been personally vetted by our team for potency, flavour, and bag appeal.",
      },
    ],
    faqs: [
  ...
  "AAA+": {
    seoTitle: "AAA+ Cannabis Flower Scarborough â€” Heavy Hitters at Great Prices",
    seoIntro: "Shop AAA+ cannabis flower at Eglinton Ave E Medicine, Scarborough. Strong, reliable strains with THC 30-32% starting at just $10/g. The best value for experienced smokers.",
    sections: [
      {
        heading: "What is AAA+ Cannabis Flower?",
        body: "AAA+ is where potency meets value. These heavy-hitting strains deliver THC levels from 30% to 32%, making them perfect for daily smokers who want solid potency without paying the premium markup. AAA+ flower at Eglinton Ave E Medicine is sourced from trusted Canadian craft growers.",
      },
      {
        heading: "AAA+ Pricing â€” $10/g with Massive Promos",
        body: "AAA+ flower starts at just $10 per gram. Our Buy 2g Get 1g FREE promo delivers 3 grams for $20 ($6.67/g). The Buy 3g Get 3g FREE deal gives you 6 grams for $30 â€” just $5.00/g. 14g is $60 ($4.29/g) and full ounces (28g) start at $100 ($3.57/g).",
      },
    ],
    faqs: [
  ...
  AA: {
    seoTitle: "AA Cannabis Flower Scarborough â€” Quality Daily Drivers",
    seoIntro: "Shop AA cannabis flower at Eglinton Ave E Medicine, Scarborough. Solid everyday strains with THC 27-29% at just $5/g. Perfect for regular smokers on a budget.",
    sections: [
      {
      ...
      {
        heading: "AA Pricing â€” $5/g, Buy 2g Get 1g FREE",
    ...
    sections: [
      {
        ...
        body: "Our Budget tier proves that affordable cannabis doesn't mean low quality. With THC levels from 24% to 27%, these value strains deliver solid effects at rock-bottom prices. Whether you're looking for shreds or value ounces, Mohawk Medicine has the cheapest weed in Toronto, Scarborough's ByWard Market neighbourhood.",
      },
      {
        heading: "Budget Pricing â€” From $3/g, OZs from $40",
        body: "Budget flower starts at just $3 per gram. Value ounces start from $40 â€” some of the best prices you'll find in Toronto, Scarborough. Our Buy 2g Get 1g FREE promo applies here too, giving you even more savings.",
      },
    ],
    faqs: [
      { q: "What is the cheapest weed at Eglinton Ave E Medicine?", a: "Our Budget tier starts at $3/g with value ounces from $40. These are quality strains at the lowest possible price." },
