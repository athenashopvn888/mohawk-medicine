...
export default function BlogAdmin() {
  ...
  async function fetchPosts() {
    setLoading(true);
    try {
      const res = await fetch(`${APPS_SCRIPT_URL}?action=blog&store=MCM01&admin=1`);
    ...
    return (
      <div className={styles.loginPage}>
        <div className={styles.loginCard}>
          <div className={styles.loginLogo}>ðŸ“</div>
          <h1 className={styles.loginTitle}>Blog Admin</h1>
          <p className={styles.loginSub}>Mohawk Medicine</p>
    ...
    <div className={styles.dashboard}>
      <div className={styles.topBar}>
        <div className={styles.topLeft}>
          <h1 className={styles.dashTitle}>ðŸ“ Blog Dashboard</h1>
