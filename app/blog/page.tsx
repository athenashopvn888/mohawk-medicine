...
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzE0TyOpOKt7QeiOjKoTHEtkv73v1Rj62R8wSP8HmU7L4_W4AktBeuR53krDyS2CnFrZA/exec";
...
const STATIC_POSTS = [
  ...
  {
    slug: "best-dispensary-scarborough",
    title: "Why Mohawk Medicine is Scarborough's Best Dispensary",
    excerpt: "200+ strains, transparent pricing from $4/g, lab-tested products, and open 24 hours. Here's what makes us different.",
    date: "2026-05-03",
    category: "News",
    emoji: "🔥",
    readTime: "3 min",
  },
  {
    ...
    excerpt: "Convenience vs tradition. We compare effects, cost, discretion, and flavour to help you decide between vaping and smoking.",
    date: "2026-04-28",
    category: "Guides",
    emoji: "💨",
    readTime: "5 min",
  ...
  {
    slug: "scarborough-cannabis-laws-2026",
    title: "Scarborough Cannabis Laws in 2026 — What You Need to Know",
...
/* -- Google Reviews -- */
const REVIEWS = [
  { name: "Mike R.", rating: 5, text: "Best dispensary in the Scarborough area. Staff is super knowledgeable and the exotic strains are legit fire.", date: "2 weeks ago" },
...
export default function BlogPage() {
  ...
  return (
    <main className={styles.main}>
      ...
      {/* Blog Banner */}
      <section style={{ width: "100%", overflow: "hidden", marginTop: "100px" }}>
        <img
          src="/banners/04_Mohawk_Blog.webp"
          alt="Mohawk Medicine Blog"
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 Mohawk Medicine <span className={styles.heroAccent}>Blog</span>
          </h1>
          <p className={styles.heroSub}>
            Cannabis guides, strain reviews, and dispensary news from Scarborough&apos;s
            premium dispensary.
          </p>
        </div>
      </section>
