...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
  ...
  },
  {
    ...
    title: "Mohawk Medicine Price And Flower Tier Guide for Adults 19+",
    seoTitle: "Mohawk Medicine Price Tier Guide | Adult 19+",
    seo_title: "Mohawk Medicine Price Tier Guide | Adult 19+",
    metaDescription: "Adult 19+ guide to Mohawk Medicine flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    meta_description: "Adult 19+ guide to Mohawk Medicine flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    h1: "Mohawk Medicine Price And Flower Tier Guide for Adults 19+",
    excerpt: "A simple adult 19+ guide to Mohawk Medicine flower tiers, weights, and unit value.",
    author: "The Mohawk Medicine Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## Mohawk Medicine Price And Flower Tier Guide for Adults 19+

Mohawk Medicine keeps flower browsing simple for adults 19+ by organizing options into clear price and quality tiers. Instead of guessing where to start, shoppers can pick the grade they want first, then choose the weight that fits the visit and budget.

This guide explains how the tier ladder works, how unit value improves as the weight goes up, and how to use the live menu and store page before visiting in Toronto.
...
For the smoothest visit, open the Mohawk Medicine menu before heading out. The live menu is the best place to compare current categories, weights, and store-specific options. The store page is also useful for directions, contact details, and quick visit planning.
...
- Browse the Mohawk Medicine store page for directions, contact details, and visit planning.
...
This guide is for adults 19+ who want a simple way to understand Mohawk Medicine flower tiers before visiting.`,
    faq: "",
