...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    "slug": "mohawk-medicine-scarborough-shopper-guide",
    "oldTitle": "Mohawk Medicine Scarborough Store Guide for Adults 19+",
    "title": "Is Mohawk Medicine the Right Weed Dispensary in Scarborough for Your Visit?",
    "seoTitle": "Mohawk Medicine Weed Dispensary in Scarborough | Visit Guide",
    "seo_title": "Mohawk Medicine Weed Dispensary in Scarborough | Visit Guide",
    "metaDescription": "Plan a Scarborough visit to Mohawk Medicine with store-page checks, natural menu-category context, and useful next steps before visiting.",
    "meta_description": "Plan a Scarborough visit to Mohawk Medicine with store-page checks, natural menu-category context, and useful next steps before visiting.",
    "h1": "Is Mohawk Medicine the Right Weed Dispensary in Scarborough for Your Visit?",
    "excerpt": "A practical Scarborough visit guide for adults 19+ checking Mohawk Medicine.",
    "author": "Cedar Miles",
    "authorName": "Cedar Miles",
    "authorHandle": "@CedarCrafts",
    "authorRole": "House Writer",
    "date": "2026-07-02",
    "modifiedDate": "2026-07-11",
    "category": "Store Guide",
    "readTime": "4 min",
    "content": "## Is Mohawk Medicine the Right Weed Dispensary in Scarborough for Your Visit?\n\nShort answer: Mohawk Medicine is the store page to use when you are planning a Scarborough cannabis stop and want the right local context before leaving. Confirm the storefront, scan the menu categories, and use the store page for current details. This guide keeps the decision practical for adults 19+ without turning the visit into guesswork.\n\n## Confirm The Store Before You Compare\n\nSearch results can make nearby cannabis stores blur together, especially when a shopper is comparing a few map listings at the same time. Mohawk Medicine is tied to Scarborough, Eglinton East, Kennedy Road, and nearby east Toronto routes. That local wording is useful because it helps shoppers confirm they are reading about the right storefront before they start comparing menu categories.\n\nThe best first move is simple: open the store page, check that the name and area match the visit you are planning, and then choose the product category you want to browse. A weed dispensary in Scarborough should make that path easy to follow, not force shoppers through a pile of repeated city keywords.\n\nThat matters for commercial searches too. A shopper may search for a cannabis dispensary, weed store, cheap weed, or affordable weed and still need the same basic answer: which store page should they trust for the next step. This article keeps that answer tied to Mohawk Medicine and the local page context already supported by the site.\n\n## What To Check Before Leaving\n\nUse the store page as the final checkpoint before heading out. It is the cleanest place to confirm the store identity, local page context, directions, contact options, and the broad menu path that fits the visit. If timing or a current item question matters, contact the store directly before leaving.\n\nThis is also where practical browsing starts. Some shoppers want affordable weed or budget weed first, while others want premium flower, exotic flower, pre-rolls, edibles, THC vapes, or concentrates. Starting with the right section makes the next question sharper.\n\n## Browse With A Clear First Question\n\nA focused visit usually starts with one question: what category are you trying to compare today? Flower shoppers can use the flower sections. Pre-roll shoppers should start with pre-rolls. Edible, THC vape, concentrate, and accessory shoppers should use those category paths instead of scanning everything at once.\n\nThat does not promise a specific product will be available. Menus change, and the current listing is what matters. The category simply gives the shopper a better way to ask about what is listed right now.\n\n## Keep The Visit Practical\n\nFor Mohawk Medicine, the useful route is: confirm the store page, choose the first category, then ask staff about current listings if something needs clarification. That is enough structure for shoppers who want a cannabis store in Scarborough without adding unsupported claims about inventory, pricing, hours, ratings, or personal experiences.\n\n## Helpful Takeaway\n\nUse this article as a planning guide, not a stock promise. If you want a smoother visit, decide whether you are comparing cheap weed, flower sections, pre-rolls, edibles, THC vapes, concentrates, or accessories before you call or visit. Then use the store page for the current store-specific details.",
    "faq": "",
    "internal_links_used": "",
    "editorialRemark": {
      "label": "Another House Writer Adds",
      "authorName": "Ari Craft",
      "authorHandle": "@AriMohawk",
      "authorRole": "House Writer",
    ...
    "primaryKeyword": "weed dispensary in Scarborough",
    "wordCount": 539
  },
  {
    "slug": "mohawk-medicine-price-flower-tier-guide",
    "oldTitle": "Mohawk Medicine Price and Flower Tier Guide",
    "title": "How Mohawk Medicine Flower Sections Help Shoppers Compare",
    "seoTitle": "Mohawk Medicine Flower Sections | Budget to Exotic Flower Guide",
    "seo_title": "Mohawk Medicine Flower Sections | Budget to Exotic Flower Guide",
    "metaDescription": "Compare Mohawk Medicine flower sections including Budget, AA, AAA+, Premium, and Exotic without relying on old prices or unsupported stock claims.",
    "meta_description": "Compare Mohawk Medicine flower sections including Budget, AA, AAA+, Premium, and Exotic without relying on old prices or unsupported stock claims.",
    "h1": "How Mohawk Medicine Flower Sections Help Shoppers Compare",
    "excerpt": "How to use Mohawk Medicine flower sections to compare current listings.",
    "author": "Ari Craft",
    "authorName": "Ari Craft",
    "authorHandle": "@AriMohawk",
    "authorRole": "House Writer",
    ...
    "rewriteAction": "RETITLE AND REWRITE",
    "primaryKeyword": "Mohawk Medicine flower sections",
    "wordCount": 545
  },
  {
    "slug": "mohawk-medicine-local-visit-guide-2026",
    "oldTitle": "Mohawk Medicine Local Visit Guide for Adults 19+",
    "title": "Mohawk Medicine Menu Categories for a Focused Toronto Visit",
    "seoTitle": "Mohawk Medicine Menu Categories | Toronto Cannabis Store Guide",
    "seo_title": "Mohawk Medicine Menu Categories | Toronto Cannabis Store Guide",
    "metaDescription": "Use this Mohawk Medicine menu guide to choose among flower, pre-rolls, edibles, THC vapes, concentrates, and accessories before visiting.",
    "meta_description": "Use this Mohawk Medicine menu guide to choose among flower, pre-rolls, edibles, THC vapes, concentrates, and accessories before visiting.",
    "h1": "Mohawk Medicine Menu Categories for a Focused Toronto Visit",
    "excerpt": "A focused Toronto menu-category guide for Mohawk Medicine.",
    "author": "Mohawk Crafts Desk",
    "authorName": "Mohawk Crafts Desk",
    "authorHandle": "@MohawkCraftsDesk",
    "authorRole": "Store Editorial Desk",
    "date": "2026-07-09",
