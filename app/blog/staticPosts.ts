...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "Is Mohawk Medicine the Right Weed Dispensary in Toronto for Your Visit?",
    "seoTitle": "Mohawk Medicine Weed Dispensary in Toronto | Visit Guide",
    "seo_title": "Mohawk Medicine Weed Dispensary in Toronto | Visit Guide",
    "metaDescription": "Plan a Toronto visit to Mohawk Medicine with store-page checks, menu categories, and practical next steps for adults 19+.",
    "meta_description": "Plan a Toronto visit to Mohawk Medicine with store-page checks, menu categories, and practical next steps for adults 19+.",
    "h1": "Is Mohawk Medicine the Right Weed Dispensary in Toronto for Your Visit?",
    "excerpt": "A practical Toronto visit guide for adults 19+ checking Mohawk Medicine.",
    "author": "Cedar Miles",
  ...
  },
  {
    ...
    "title": "Mohawk Medicine Flower Guide: Budget, Premium and Exotic Sections",
    "seoTitle": "Mohawk Medicine Flower Guide | Toronto Budget to Exotic",
    "seo_title": "Mohawk Medicine Flower Guide | Toronto Budget to Exotic",
    "metaDescription": "Compare Mohawk Medicine flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "meta_description": "Compare Mohawk Medicine flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "h1": "Mohawk Medicine Flower Guide: Budget, Premium and Exotic Sections",
    "excerpt": "A clear flower guide for Mohawk Medicine, from cheap weed and budget weed searches to premium flower and exotic flower browsing.",
    "author": "Ari Craft",
    "authorName": "Ari Craft",
    "authorHandle": "@AriMohawk",
    "authorRole": "House Writer",
    ...
    "rewriteAction": "POLISHED PUBLIC COPY",
    "primaryKeyword": "Mohawk Medicine flower guide",
    "wordCount": 545
  },
  {
    "slug": "mohawk-medicine-local-visit-guide-2026",
    "oldTitle": "Mohawk Medicine Local Visit Guide for Adults 19+",
    "title": "Mohawk Medicine Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "seoTitle": "Mohawk Medicine Menu Guide | Toronto Weed Store Categories",
    "seo_title": "Mohawk Medicine Menu Guide | Toronto Weed Store Categories",
    "metaDescription": "Use this Mohawk Medicine menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "meta_description": "Use this Mohawk Medicine menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "h1": "Mohawk Medicine Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "excerpt": "A practical Toronto menu guide for Mohawk Medicine, with natural category paths for adults 19+.",
    "author": "Cedar Miles",
    "authorName": "Cedar Miles",
    "authorHandle": "@CedarCrafts",
    "authorRole": "House Writer",
    ...
    "rewriteAction": "POLISHED PUBLIC COPY",
    "primaryKeyword": "Mohawk Medicine menu guide",
    "wordCount": 493
  }
];
