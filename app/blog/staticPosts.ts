...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    title: "Mohawk Medicine Scarborough Store Guide for Adults 19+",
    seoTitle: "Mohawk Medicine Guide | Toronto Adult 19+",
    seo_title: "Mohawk Medicine Guide | Toronto Adult 19+",
    metaDescription: "Adult 19+ guide to Mohawk Medicine in Scarborough, with local store-page checks, menu-category context, and safe visit planning.",
    ...
    readTime: "4 min",
    content: `## Mohawk Medicine Local Store Guide for Adults 19+

Mohawk Medicine serves adults 19+ looking for store information in Scarborough. Use this guide to get oriented, compare the store page with menu categories, and choose the most useful next step before visiting.
...
Mohawk Medicine is tied to Eglinton East and Kennedy Road context in Toronto. Useful local content should make the page easier for shoppers to understand by connecting the store to nearby streets, neighbourhood language, and visit-planning details already supported by the site.
...
Start with the official Mohawk Medicine store page, then use the menu/category links to browse what the site makes easy to compare. Shoppers can confirm the right storefront, directions, contact options, and local visit details in one place.
...
### Is this guide for Mohawk Medicine only?

Yes. This guide is written for Mohawk Medicine and the local Toronto context connected to this website.
...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
    faq: "",
    internal_links_used: "[Mohawk Medicine Toronto store page](/weed-dispensary-toronto)\\n[Mohawk Medicine homepage](/)\\n[More Mohawk Medicine guides](/blog)",
    relatedLinks: [
      {
            "title": "Mohawk Medicine Toronto store page",
  ...
  },
  {
    ...
    title: "Mohawk Medicine Price and Flower Tier Guide",
    seoTitle: "Mohawk Medicine Price Tier Guide",
    seo_title: "Mohawk Medicine Price Tier Guide",
    metaDescription: "Mohawk Medicine guide to flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    meta_description: "Mohawk Medicine guide to flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    h1: "Mohawk Medicine Price and Flower Tier Guide",
    excerpt: "A simple guide to Mohawk Medicine flower tiers, weights, and unit value.",
    author: "The Mohawk Medicine Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## Mohawk Medicine Price and Flower Tier Guide

Mohawk Medicine makes flower shopping easier by organizing the menu into clear tiers. Start with the tier that matches the kind of flower you want, then choose the weight that fits your budget and visit.
...
For the smoothest visit, open the Mohawk Medicine menu before heading out. The live menu is the best place to compare current flower tiers, weights, and store-specific options. The store page is also useful for directions, contact details, and visit planning.
...
- Open the Mohawk Medicine store page for directions, contact details, and visit planning.
...
Use the live menu for current store-specific selection, then use the store page for directions, contact details, and visit planning.`,
  ...
  },
  {
    ...
    metaDescription: "Plan a visit to Mohawk Medicine in Toronto with adult 19+ store-page checks, menu-category paths, and local directions context.",
    meta_description: "Plan a visit to Mohawk Medicine in Toronto with adult 19+ store-page checks, menu-category paths, and local directions context.",
    ...
    readTime: "4 min",
    content: `Use this guide to confirm the right Mohawk Medicine storefront around Scarborough and east Toronto, understand nearby street context, and choose the most useful store page or menu path before visiting.
