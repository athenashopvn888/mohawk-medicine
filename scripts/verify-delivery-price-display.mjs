...
assert(/#main-nav\s*\{[^}]*position:\s*fixed\s*!important;[^}]*top:\s*var\(--delivery-announcement-height\)\s*!important;/s.test(stylesSource), "Mohawk main navigation must remain fixed beneath the announcement");
