"""
Mohawk Crafts & Medicine — Product Update Script
===================================
Drop your ONHAND CSV into the mohawk-crafts folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  Mohawk Crafts & Medicine — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://mohawkcraftsandmedicine.com")
    else:
