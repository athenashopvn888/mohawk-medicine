"""
Mohawk Crafts & Medicine - Auto Sync from Google Sheets
==========================================
...
a filtered menu for Mohawk Crafts & Medicine (ALC01).
...
# ============================================================
STORE_CODE = "MCM01"  # After Dark store code
...
def main():
    print("=" * 60)
    print(f"  Mohawk Crafts & Medicine - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://mohawkcraftsandmedicine.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
